         ...
         <div className="flex gap-4">
           {activeTab === 'registry' && (
             <>
               ...
               >
                 <FileUp className="w-4 h-4" /> Importer CSV
               </button>
        ...
        <>
          ...
          <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm flex flex-wrap items-center justify-between gap-6 no-print">
            <div className="flex items-center gap-4 flex-1 min-w-[300px]">
               ...
               <select className="bg-slate-50 border border-slate-100 px-4 py-3 rounded-xl text-[10px] font-black uppercase outline-none" value={filterSite} onChange={(e) => setFilterSite(e.target.value)}>
