...
export const LoginView = ({ enterpriseName, onLogin }: LoginViewProps) => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1a3a22] p-6 relative overflow-hidden">
      ...
      <div className="bg-white w-full max-w-md rounded-[4rem] p-12 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] animate-fade-in relative z-10 border border-white/20">
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-2 mt-3">
             ...
             <p className="text-[10px] font-black uppercase text-slate-400 tracking-[0.2em]">Authentification</p>
             <div className="h-px w-8 bg-slate-100" />
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 flex items-center gap-4">
            ...
            <div>
              <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Session Sécurisée</p>
              <p className="text-[11px] font-bold text-slate-700 italic">Accès Administrateur Détecté</p>
            </div>
          </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-[9px] font-black uppercase tracking-[0.25em] text-slate-300">
            SmartStock v3.5 Pro Intelligent
          </p>
          <div className="mt-4 pt-4 border-t border-slate-50">
            <p className="text-[11px] font-header italic text-slate-400">
      ...
      {/* Micro-points de fond (reprise du style index.html) */}
